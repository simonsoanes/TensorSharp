    ...
    const void* final_norm_data)
{
    ...
    try
    {
        ...
        for (int l = 0; l < num_layers; l++)
        {
            ...
            {
                t.gate_exps = ggml_new_tensor_3d(ctx, wtype(d.gate_exps_f16, d.ge_type), d.ge_ne0, d.ge_ne1, nExp);
                t.up_exps = ggml_new_tensor_3d(ctx, wtype(d.up_exps_f16, d.ue_type), d.ue_ne0, d.ue_ne1, nExp);
                t.down_exps = ggml_new_tensor_3d(ctx, wtype(d.down_exps_f16, d.de_type), d.de_ne0, d.de_ne1, nExp);
